...
#
# Generated by Vivado on Tue Jan 30 15:25:28 -0500 2024
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/arous/Bureau/APP2/pb_logique_seq/pb_logique_seq.cache/compile_simlib/activehdl"
  fi
